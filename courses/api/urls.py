...
urlpatterns = [
  ...
  path('<int:course_id>/quiz/questions/<int:question_id>/submit_answer', CourseQuizAnswer.as_view(), name='course_quiz_answer'),
  ...
  path('<int:course_id>/contents/<int:content_id>/quiz/questions/<int:question_id>/submit_answer', ContentQuizAnswer.as_view(), name='content_quiz_answer'),
